""" Connects client to server and starts two threads for sending and receiving the data from server. While sending the data to server it format the information into
'FROM ~ GROUP_ID ~ To ~ MESSAGE' form, so that server can check to whom the messages should be forwarded. """
